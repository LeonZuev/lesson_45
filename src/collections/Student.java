...
public class Student implements Comparable<Student> {
  ...
  public static Student reedStudent() throws IOException {
...
//  }
  ...
  @Override
  public int compareTo(Student other) {           //если рейтинг одинаковый
    if (/*this.*/score != other.score) {          // то сравниваем рейтинг
